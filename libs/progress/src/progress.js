...
*/
  ...
  function _setPercentFor(targetElement, percent) {
    ...
    if (targetElement.hasAttribute("data-progressjs")) {
      ...
      setTimeout(function() {
        ...
        var bgpos = '0px'+ ' ' + -parseInt(percent)+'px';
        percentElement.style.backgroundPosition = bgpos;
   ...
   */
  function _end() {
    console.log(typeof this._onBeforeEndCallback);
    //call onBeforeEnd callback
    if (typeof this._onBeforeEndCallback != 'undefined') {
      if (this._options.considerTransition === false) {
